...
export class ScrollController {
  constructor() {
    ...
    this.config = (typeof AppConfig !== 'undefined') ? {
  ...
  setupScrollHandler() {
    ...
    const throttledScrollHandler = (typeof Utils !== 'undefined' && Utils.throttle)
      ? Utils.throttle(handleScroll, this.config.THROTTLE_MS)
      : handleScroll;
